...
namespace ExploreAll.UI
{
    ...
    public class InteractivePieChart : TemplateControl
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            //string jspiechart = "var chart = c3.generate({" +
            ...
            //registerJavaScript(jspiechart);
        }

        //public void registerJavaScript(string jspiechart)
        //{
        //    ScriptManager scr = ScriptManager.GetCurrent(Page);

        //    if ((scr != null) && (scr.IsInAsyncPostBack))
        //    {
        //        ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Guid.NewGuid().ToString(), jspiechart, true);
        //    }
        //    else
        //    {
        //        Page.ClientScript.RegisterStartupScript(this.GetType(), this.ClientID + "_startup", jspiechart, true);
        //    }
        //}
