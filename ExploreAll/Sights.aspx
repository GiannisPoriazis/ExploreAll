    ...
    <div class="container-fluid full-height">
        <div class="row row-height">
            <div class="col-lg-7 col-md-6 content-left">
                ...
                <asp:Literal runat="server" ID="SightsWrapper">
                    <div class="row">                    
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="img_wrapper">
                                ...
                                <div class="tools_i">
                                    <div class="directions_list_map" onclick="onHtmlClick('Bars', 2)">
                                        <a class="tooltip_styled tooltip-effect-4"><span class="tooltip-item"></span>
								    <div class="tooltip-content">View on map</div>
								    </a>
                                    </div>
                                ...
                                <div class="img_container">
                                    <a href="florence-bar-detail.html">
                                        <img src="img/bar_list_3.jpg" width="800" height="533" class="img-responsive" alt="">
                                        <div class="short_info">
                                            <h3>Francis Bar</h3>
                                            <em>Cocktails - Pub</em>
                                            <p>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="img_wrapper">
                                ...
                                <div class="tools_i">
                                    <div class="directions_list_map" onclick="onHtmlClick('Bars', 3)">
                                        <a class="tooltip_styled tooltip-effect-4"><span class="tooltip-item"></span>
								    <div class="tooltip-content">View on map</div>
								    </a>
                                    </div>
                                ...
                                <div class="img_container">
                                    <a href="florence-bar-detail.html">
                                        <img src="img/bar_list_4.jpg" width="800" height="533" class="img-responsive" alt="">
                                        <div class="short_info">
                                            <h3>Visconti Bar</h3>
                                            <em>Coffee bar</em>
                                            <p>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="img_wrapper">
                                ...
                                <div class="tools_i">
                                    <div class="directions_list_map" onclick="onHtmlClick('Bars', 4)">
                                        <a class="tooltip_styled tooltip-effect-4"><span class="tooltip-item"></span>
								    <div class="tooltip-content">View on map</div>
								    </a>
                                    </div>
                                ...
                                <div class="img_container">
                                    <a href="florence-bar-detail.html">
                                        <img src="img/bar_list_5.jpg" width="800" height="533" class="img-responsive" alt="">
                                        <div class="short_info">
                                            <h3>Florence Mojito</h3>
                                            <em>Cocktails</em>
                                            <p>
                                                A quam morbi ut arcu, eget neque molestie, ullamcorper congue pharetra, hendrerit odio consectetuer.
                                            </p>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="img_wrapper">
                                ...
                                <div class="tools_i">
                                    <div class="directions_list_map" onclick="onHtmlClick('Bars', 5)">
                                        <a class="tooltip_styled tooltip-effect-4"><span class="tooltip-item"></span>
								    <div class="tooltip-content">View on map</div>
								    </a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="img_wrapper">
                                ...
                                <div class="tools_i">
                                    <div class="directions_list_map" onclick="onHtmlClick('Bars', 6)">
                                        <a class="tooltip_styled tooltip-effect-4"><span class="tooltip-item"></span>
								    <div class="tooltip-content">View on map</div>
								    </a>
                                    </div>
                                ...
                                <div class="img_container">
                                    <a href="florence-bar-detail.html">
                                        <img src="img/bar_list_7.jpg" width="800" height="533" class="img-responsive" alt="">
                                        <div class="short_info">
                                            <h3>La Grotta</h3>
                                            <em>Coffee - Pub</em>
                                            <p>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="img_wrapper">
                                ...
                                <div class="tools_i">
                                    <div class="directions_list_map" onclick="onHtmlClick('Bars', 7)">
                                        <a class="tooltip_styled tooltip-effect-4"><span class="tooltip-item"></span>
								    <div class="tooltip-content">View on map</div>
								    </a>
                                    </div>
                                ...
                                <div class="img_container">
                                    <a href="florence-bar-detail.html">
                                        <img src="img/bar_list_8.jpg" width="800" height="533" class="img-responsive" alt="">
                                        <div class="short_info">
                                            <h3>Domenico</h3>
                                            <em>Cocktails</em>
                                            <p>
