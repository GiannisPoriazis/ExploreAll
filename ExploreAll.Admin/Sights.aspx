...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContent" runat="server">
    <exploreall:Grid runat="server" DataSource="SightsTable" ID="SightsGrid" Editable="true" Permission="2" GridStyle="alpine" WrapperCssClass="FullWidth Controls"></exploreall:Grid>
